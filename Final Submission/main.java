...
public class main{
    ...
    public static void startBattle(String playerName, Player Player1, Enemy enemy)
    {
        ...
        {		
            ...
            while(b)
            {
	            ...
	            System.out.print("Enter the name of the card or a numbercd to play it. \n|");
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Scanner input = new Scanner(new File("C:\\Users\\meetg\\OneDrive\\Desktop\\Final Submission\\application\\application\\cardList.txt"));
        while(input.hasNext())
        {
